#ifndef AMBS_CALCULATORS_COMPARATORS_FLOAT_PARAM_COMPARATOR_H
#define AMBS_CALCULATORS_COMPARATORS_FLOAT_PARAM_COMPARATOR_H
...
#endif  // AMBS_CALCULATORS_COMPARATORS_FLOAT_PARAM_COMPARATOR_H
