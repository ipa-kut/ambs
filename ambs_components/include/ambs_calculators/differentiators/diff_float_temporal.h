#ifndef AMBS_CALCULATORS_DIFFERENTIATORS_DIFF_FLOAT_TEMPORAL_H
#define AMBS_CALCULATORS_DIFFERENTIATORS_DIFF_FLOAT_TEMPORAL_H
...
#endif  // AMBS_CALCULATORS_DIFFERENTIATORS_DIFF_FLOAT_TEMPORAL_H
