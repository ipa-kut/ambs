#ifndef AMBS_CALCULATORS_DIFFERENTIATORS_DIFF_POSE_TEMPORAL_H
#define AMBS_CALCULATORS_DIFFERENTIATORS_DIFF_POSE_TEMPORAL_H
...
void DiffPoseTemporal::printPose(geometry_msgs::PoseStamped pose)
{
  ROS_INFO_STREAM(node_name_ << ": (" << pose.pose.position.x << ", "
                                      ...
                                      << ambs_base::getYawDegreesFromQuaternion(pose.pose.orientation) << " deg)");
}


}  // namespace ambs_calculators

#endif  // AMBS_CALCULATORS_DIFFERENTIATORS_DIFF_POSE_TEMPORAL_H
