#ifndef AMBS_CALCULATORS_DIFFERENTIATORS_STOPWATCH_H
#define AMBS_CALCULATORS_DIFFERENTIATORS_STOPWATCH_H
...
#endif  // AMBS_CALCULATORS_DIFFERENTIATORS_STOPWATCH_H
